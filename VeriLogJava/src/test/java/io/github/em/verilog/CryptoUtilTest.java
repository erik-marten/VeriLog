...
public class CryptoUtilTest {
    ...
    @Test
    void hex_roundTrips_and_accepts_uppercase() throws VeriLogFormatException {
    ...
    void should_reject_odd_length() {
        assertThrows(VeriLogFormatException.class, () -> CryptoUtil.fromHex("abc"));
    }

    @Test
    void should_reject_invalid_characters() {
        assertThrows(VeriLogFormatException.class, () -> CryptoUtil.fromHex("zz"));
    }
}
